...
up:
	...
	@echo "    👉 Swagger UI:	http://localhost:${NGINX_HOST_HTTP_PORT}/user-management-api/swagger/index.html"
	@echo "    👉 gRPC UI:		http://localhost:${NGINX_HOST_HTTP_PORT}/user-management-api/grpcui/"
	@echo "    🔧 Command examples:"
	@echo "        curl http://localhost:${NGINX_HOST_HTTP_PORT}/user-management-api/health"
	@echo ""
